        ...
        if not filtered:
            ...
            edited = st.data_editor(
                ...
                column_config={
                    ...
                    "거래": st.column_config.TextColumn("거래", width="small", disabled=False),
                    "매물명": st.column_config.TextColumn("매물명", disabled=False),
                    "주소": st.column_config.TextColumn("주소", disabled=False),
                    "호가": st.column_config.NumberColumn("호가", format="%d만", disabled=False),
                    "시세갭": st.column_config.TextColumn("시세갭", help="양수=저평가", disabled=True),
                    "평당가(원)": st.column_config.NumberColumn("평당가", format="%d원", disabled=False),
